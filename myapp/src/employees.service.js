const employees = [
  {
    ...
    HireDate: '2020-05-01T00:00:00.000Z',
    Address: 'Academ city, Lenina, 5',
    City: 'Novosibirsk',
    Region: 'NSO',
    PostalCode: '98122',
    Country: 'Russia',
    HomePhone: '(206) 111-1122',
    Extension: '5467',
    Photo: 'https://js.devexpress.com/Demos/WidgetsGallery/JSDemos/images/employees/06.png',
    Notes: 'Прсосто живет и чувствует себя прекрасно.',
    ReportsTo: 2,
  },
  {
    EmployeeID: 2,
    ...
    Position: 'Policman',
    TitleOfCourtesy: 'Officer.',
    BirthDate: '1998-02-19T00:00:00.000Z',
    HireDate: '2020-08-14T00:00:00.000Z',
    Address: 'Novosibirs, Lenina, 6',
    City: 'Novosibirsk',
    Region: 'NSO',
    PostalCode: '98401',
    Country: 'Russia',
...
/* В этом файле данные в виде массива с объектами к которым мы можем обратиться через их свойства */
